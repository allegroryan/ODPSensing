...
int trigPin=10;
int echoPin1=2; //Back
int echoPin2=5; //Right Side
int echoPin3=4; //Front Right
int echoPin4=6; //Front Left
long duration1;
long duration2;
long duration3;
long duration4;
...
void setup() {
  ...
  Enes100.begin("-=xxxXXX[Operation Dark Phoenix]XXXxxx=-", BLACK_BOX, 10, 1, 0);
  Enes100.println("-=xxxXXX[Operation Dark Phoenix]XXXxxx=- IN DIS BITS:");
...
void testRun(){
  ...
  Enes100.print("Back Sonar: ");
  Enes100.println(sonarReadDistanceSensor(10));
}
...
void dodgeObstacle(){
  ...
  updateNavigation();
  driveDestination(false, 255, (Enes100.location.x + 0.5), (Enes100.location.y + 0.4));
  delay(3000);
  updateNavigation();
